...
import org.jcm.prismutils.newPolicyReader;
 ...
 *
 */
public class HQSolverIterative implements HQSolver {
	...
	protected HashMap<String, ArrayList<String>> m_policies = new HashMap<String, ArrayList<String>>();
	protected HashMap<String, String> m_structures_tikz = new HashMap<String, String>();
	protected AlloyConnector m_ac;
	protected PrismConnector m_pc;
	...
	protected static Boolean m_sim_enabled=false;
	protected boolean m_export_models=false;
	protected boolean m_export_policies=false;
...
//	private static PrismCL m_prismcl=new PrismCL();
	...
	public HQSolverIterative(String tmp_path){
	...
	public void setExportPolicies(boolean val) {
		m_export_policies=val;
	}
	
	public HQSolverIterative(String tmp_path, String engine){
		m_tmp_path = tmp_path;
	...
	/** 
	 * Obtain number of solutions generated
	 */
...
//		m_pc.setModelCheckUnderStrategy(false);		
		...
		for (Map.Entry<String, String> e: m_solutions.entrySet()){
			...
			if (!m_sim_enabled){
				...
				newPolicyReader pr = new newPolicyReader(myPolicy);
				
				if (m_export_policies) {
					pr.readPolicy();
					m_policies.put(e.getKey(), pr.getPlan());
				}
				m_scoreboard.addSolutionforProperty(e.getKey(), property_alias, res, constStr);
				if (m_debug)
	...
	public void exportConfigurations(String filepath, HQSolverIterative.StructureExport export_mode){
	...
	public void exportPolicies(String filepath, HQSolverIterative.PolicyExport export_mode, ArrayList<String> params) {
